...
namespace SmartEducation.Application.ViewModel.Student
{
    public class Vm_StudentInfo
    {
        ...
        #region Navigation_Propery
        public IQueryable<StudentInfo> StudentInfos { get; set; }
